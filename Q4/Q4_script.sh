#!/bin/bash
#SBATCH --job-name=Q4_script # Replace JOB_NAME with a name you like
...
spark-submit --driver-memory 10g --executor-memory 10g /users/acp23pks/com6012/ScalableML/Code/Q4_code.py  
